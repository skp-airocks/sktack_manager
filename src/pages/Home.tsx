    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-2xl mx-auto px-6 text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-8">
          <Link
            to="/login"
            className="w-full sm:w-auto px-8 py-4 bg-gradient-to-r from-cyan-500 to-emerald-500 text-white font-semibold rounded-lg shadow-lg shadow-cyan-500/30 hover:shadow-cyan-500/50 hover:scale-105 transition-all duration-200 flex items-center justify-center gap-2"
          >
            Login
          </Link>
          ...
          <Link
            to="/signup"
            className="w-full sm:w-auto px-8 py-4 bg-transparent border-2 border-slate-600 text-white font-semibold rounded-lg hover:border-slate-400 hover:bg-slate-800/50 transition-all duration-200"
          >
            Sign Up
          </Link>
        </div>
        ...
        <Link
          to="/dashboard"
          className="text-slate-500 hover:text-cyan-400 font-medium transition-colors duration-200 underline underline-offset-4 decoration-dotted"
        >
          Go to Dashboard
        </Link>
